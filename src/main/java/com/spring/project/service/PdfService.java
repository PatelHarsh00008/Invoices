...
public class PdfService {
	...
	public byte[] createPdf(Invoice invoice) {
		...
		String urlOfImage = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQllxkOwWt4ZzTCB5lDPGTWtis6d34_GUIAW6M5H5k&s";
		document.open();
	...
	private void makeHeader(PdfPTable header, String urlOfImage, Invoice invoice) {
		...
		PdfPCell cell = new PdfPCell();
		cell.addElement(new Phrase("ONTARIO INC.", bold));
		cell.addElement(new Phrase("1234 Ontario Road, Unit # 4XYZ\n" +
				"Oakville Ontario LXHYTZ\nPhone:- 999-999-9999", normal));
		header.addCell(cell);
